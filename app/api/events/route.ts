...
export async function POST(req:NextRequest){
    try {
        ...
        return NextResponse.json({message:"Successfully created",event: createdEvent},{status:201 });
    }catch(e){
        console.error(e);
...
export async function GET() {
    try {
        ...
        return NextResponse.json({message:"event fetching not  Found" , error :e} , {status :500}  );
    }
}